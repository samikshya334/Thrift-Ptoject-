        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (user != null)
                    {
                        // Check if the user is the predefined admin user
                        if (user.Email.Equals("admin0@gmail.com", StringComparison.OrdinalIgnoreCase))
                        {
                        ...
                        {
                            // Redirect to the home page for buyers
                ...
                // ... other conditions like 2FA, lockout, etc.
            }
